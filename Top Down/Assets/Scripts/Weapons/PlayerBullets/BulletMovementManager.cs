...
public class BulletMovementManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        maxVelocity = bulletManager.bulletInfo.moveSpeed;
    ...
    private void HandleBulletMovement()
    {
        ...
        bulletManager.rb.velocity = Vector2.Lerp(bulletManager.rb.velocity, transform.up * maxVelocity, speedChangeTime);
